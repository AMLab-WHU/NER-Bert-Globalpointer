...
tokenizer = AutoTokenizer.from_pretrained(config["bert_path"], add_special_tokens=True, do_lower_case=False)
...
def load_model():
    ...
    model_state_path = r'outputs/split_20/2024-07-02_08.40.19/model_state_dict_20.pt'
